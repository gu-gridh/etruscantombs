...
router.register(rf'{endpoint}/objectmesh', views.Object3DHopViewSet, basename='object mesh')
router.register(rf'{endpoint}/objectpointcloud', views.ObjectPointcloudViewSet, basename='object point cloud')
router.register(rf'{endpoint}/object3js', views.Object3jsViewSet, basename='object Three js')
